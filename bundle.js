...
function Car() {
    ...
    const color = pickRandom$3(vehicleColors);
...
function BigTruck() {
    ...
    const color = pickRandom$2(vehicleColors);
...
function PickupTruck() {
    ...
    const color = pickRandom$1(vehicleColors);
...
scene.background = new Color( 0x6969aa );
...
const vehicleColors$1 = [0xa82bf0, 0xf03030, 0xf0b630, 0x50f030, 0x3053f0, 0x626d73];

pickRandom(vehicleColors$1);
